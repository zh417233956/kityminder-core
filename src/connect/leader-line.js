...
修改1.define(function(require, exports) {原内容;exports.LeaderLine = LeaderLine;}
    ...
    var LeaderLine = function() {
                        ...
                        k.forEach(function(e) {
                            ...
                            if (e.framesStart) {
                                ...
                                e.reverse && (t = e.duration - t),
                                    a = e.frames[e.lastFrame = Math.round(t / b)], !1 !== e.frameCallback(a.value, !1, a.timeRatio, a.outputRatio) ? o = !0 : e.framesStart = null
                            }
                        }),
                        o && (e = t.call(window, l))
                }
                        ...
                        o.prototype = {
                            ...
                            _parseNumber: function() {
                                ...
                                if (this._currentIndex !== r)
                                    for (var s = this._currentIndex - 1,
        ...
        return te = {
                dash: {
                    ...
                    optionsConf: [
                        ["type", "len", "number", null, null, null,
                            function(e) {
                                return 0 < e
                            }
                        ],
                ...
                gradient: {
                    ...
                    init: function(e) {
                        ...
                        e.efc_gradient_gradient = t = n.appendChild(a.createElementNS(b, "linearGradient")),
                            t.id = i,
                            t.gradientUnits.baseVal = SVGUnitTypes.SVG_UNIT_TYPE_USERSPACEONUSE, [t.x1, t.y1, t.x2, t.y2].forEach(function(e) {
                                e.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX, 0)
                            }),
                ...
                dropShadow: {
                    ...
                    optionsConf: [
                        ...
                        ["type", "blur", null, null, null, 3,
                            function(e) {
                                return 0 <= e
                            }
                        ],
                        ["type", "color", null, null, null, "#000", null, !0],
                        ["type", "opacity", null, null, null, .8,
                            function(e) {
                                return 0 <= e && e <= 1
                            }
                        ]
                                ...
                                case "rect":
                                    (v = {
                                        ...
                                        (E = t.radius ? t.radius <= x ? t.radius : x : 0) ? (O = E - (w = (E - k) / Math.SQRT2), I = E * U, M = [{
                                            ...
                                            M[3]
                                        ]), M[3].y !== M[4].y && P.pathListRel.push([M[3], M[4]]), P.pathListRel.push([M[4], {
                                                x: M[4].x,
                                                y: M[4].y + I
                                            },
                                            {
                                            ...
                                            M[5]
                                        ]), M[5].x !== M[6].x && P.pathListRel.push([M[5], M[6]]), P.pathListRel.push([M[6], {
                                                x: M[6].x - I,
                                                y: M[6].y
                                            },
                                            {
                                            ...
                                            M[7]
                                        ]), M[7].y !== M[0].y && P.pathListRel.push([M[7], M[0]]), P.pathListRel.push([]), O = E - w + P.strokeWidth / 2, M = [{
                                                x: v.left - O,
                                                y: v.top - O
                                            },
                                            {
