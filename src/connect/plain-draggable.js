...
修改1.define(function(require, exports) {{原内容;exports.PlainDraggable = PlainDraggable;}}
*/
define(function(require, exports) {
    var PlainDraggable = function(t) {
        ...
        function s() {
            var t = void 0,
                e = void 0;
            u && (a.call(window, u), u = null),
                o.forEach(function(e) {
                    var n;
                    (n = e.event) && (e.event = null, e.listener(n), t = !0)
                }),
                t ? (l = Date.now(), e = !0) : Date.now() - l < r && (e = !0),
                e && (u = i.call(window, s))
        }
        ...
        var y = function() {
            ...
            return f(t, [{
                        ...
                        value: function(t) {
                            ...
                            return e.startHandlers[++e.lastHandlerId] = function(n) {
                                    var r = "mousedown" === n.type ? "mouse" : "touch",
                                        ...
                                        i = void 0,
                                        a = void 0;
                                    if ("touch" === r) e.lastTouchTime = o,
                                        i = n.changedTouches[0],
                                        a = n.changedTouches[0].identifier;
                                    else {
                                    ...
                                    e.curPointerClass && e.cancel(),
                                        t.call(e, i) && (e.curPointerClass = r, e.curTouchId = "touch" === r ? a : null, e.lastPointerXY.clientX = i.clientX, e.lastPointerXY.clientY = i.clientY, e.options.preventDefault && n.preventDefault(), e.options.stopPropagation && n.stopPropagation())
                                },
                                e.lastHandlerId
                        }
                    },
                    ...
                    },
                    {
                        ...
                        value: function(t, e) {
                            if (!this.startHandlers[e]) throw new Error("Invalid handlerId: " + e);
                            return t.removeEventListener("mousedown", this.startHandlers[e], !1),
                                t.removeEventListener("touchstart", this.startHandlers[e], !1),
                                t.removeEventListener("dragstart", g, !1),
                                e
                        }
                    },
                    {
                            ...
                            v(t, "touchcancel",
                                    function(t) {
                                        n.lastTouchTime = Date.now(),
                                            null != n.curPointerClass && (h(t.changedTouches, n.curTouchId) || !h(t.touches, n.curTouchId)) && n.cancel()
                                    }, {
                                        capture: !1,
                                        passive: !1
                                    }),
                    ...
                    },
                    {
                        key: "cancel",
                        value: function() {
                            this.curCancelHandler && this.curCancelHandler(),
                                this.curPointerClass = this.curTouchId = null
                        }
                    }
                ], [{
        ...
        var w = ["webkit", "moz", "ms", "o"],
            ...
            T = function() {
                var t = new RegExp("^(?:" + w.join("|") + ")(.)", "i"),
                    e = /[A-Z]/;
                return function(n) {
                    return "float" === (n = (n + "").replace(/\s/g, "").replace(/-([\da-z])/gi,
                        function(t, e) {
        ...
        var P = {
            ...
            getValue: function(t, e) {
                var n = void 0;
                return (t = k(t)) ? (H[t] = H[t] || {},
                    (Array.isArray(e) ? e : [e]).some(function(e) {
                        return e = B(e),
                            null != H[t][e] ? !1 !== H[t][e] && (n = H[t][e], !0) : C(t, e) ? (n = H[t][e] = e, !0) : !!S.some(function(r) {
                                var o = r + e;
        ...
        function D(t) {
            return !D.ignoreNative && t.classList ||
                function() {
        ...
        var A = 9e3,
            ...
            wt = {},
            bt = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame ||
            function(t) {
                return setTimeout(t, 1e3 / 60)
            },
            St = window.cancelAnimationFrame || window.mozCancelAnimationFrame || window.webkitCancelAnimationFrame || window.msCancelAnimationFrame ||
            function(t) {
                return clearTimeout(t)
            },
            Et = function() {
        ...
        function Ft(t) {
            ...
            if (t.top = t.y = e, (e = Yt(t.width)) && e.value >= 0) t.width = e,
                delete t.right;
            else {
            ...
            if ((e = Yt(t.height)) && e.value >= 0) t.height = e,
                delete t.bottom;
            else {
        ...
        function Nt(t, e, n) {
            ...
            return r.x = e,
                r.y = n,
                r.matrixTransform(t.svgCtmElement.getScreenCTM().inverse())
        }
        ...
        function Gt(t, e) {
            var n = t.elementBBox,
                ...
                o = t.htmlOffset,
                i = !1;
            return e.left !== n.left && (r.left = e.left + o.left + "px", i = !0),
        ...
        function Zt(t) {
            ...
            return n[ft] = "translate(" + (r.left + d.left) + "px, " + (r.top + d.top) + "px)", ["width", "height"].forEach(function(r) {
                ...
                e.offsetWidth,
                n[ct] = i,
                a.left === r.left && a.top === r.top || (n[ft] = "translate(" + (a.left + d.left) + "px, " + (a.top + d.top) + "px)"),
                a
        }
        ...
        function $t(t) {
            ...
            var l = Rt(e);
            n.position = "absolute",
                n.left = n.top = n.margin = "0";
            var u = Rt(e),
                s = t.htmlOffset = {
                    left: u.left ? -u.left : 0,
                    top: u.top ? -u.top : 0
                };
            return n.left = r.left + s.left + "px",
                n.top = r.top + s.top + "px", ["width", "height"].forEach(function(r) {
        ...
        function Jt(t) {
            ...
            var i = t.svgOriginBBox = e.getBBox(),
                ...
                s = Nt(t, r.left, r.top);
            return n.setTranslate(s.x + u.x - i.x, s.y + u.y - i.y),
                o
        }
            ...
            if (t.minLeft = o.left, t.maxLeft = o.right - r.width, t.minTop = o.top, t.maxTop = o.bottom - r.height, Ut(t, {
                ...
                var i = {
                    ...
                    s = t.parsedSnapTargets.reduce(function(t, e) {
                        ...
                        function f(n) {
                            if (null == n.center && (n.center = e.center), null == n.xGravity && (n.xGravity = e.gravity), null == n.yGravity && (n.yGravity = e.gravity), null != n.x && null != n.y) n.x = At(n.x, d.x, c.x),
                                n.y = At(n.y, d.y, c.y),
            ...
            if (c) {
                ...
                var f = "scroll" === e,
                    p = function(t, e, n) {
                        ...
                        r.scrollWidth = r.clientWidth + l,
                            r.scrollHeight = r.clientHeight + u;
                        var c = void 0;
                        return e ? r.clientX = r.clientY = 0 : (c = t.getBoundingClientRect(), a || (a = getComputedStyle(t, "")), r.clientX = c.left + (parseFloat(a.borderLeftWidth) || 0), r.clientY = c.top + (parseFloat(a.borderTopWidth) || 0)),
                            r
        ...
        function Qt(t) {
            wt.stop(),
                Mt(t.options.handle, t.orgCursor),
                lt.style.cursor = dt, !1 !== t.options.zIndex && (t.elementStyle.zIndex = t.orgZIndex),
                pt && (lt.style[pt] = vt);
            var e = X(t.element);
            xt && e.remove(xt),
                yt && e.remove(yt),
        ...
        function te(t, e) {
            ...
            function i(t, e) {
                    ...
                    if ("all" !== r) {
                        var o = {},
                            i = r.split(/\s/).reduce(function(t, e) {
                                return (e = "tl" === (e = e.trim().replace(/^(.).*?-(.).*$/, "$1$2")) || "lt" === e ? "tl" : "tr" === e || "rt" === e ? "tr" : "bl" === e || "lb" === e ? "bl" : "br" === e || "rb" === e ? "br" : null) && !o[e] && (t.push(e), o[e] = !0),
                                    t
                            }, []),
                            a = i.length;
                ...
                return !s || "containment" !== s && "document" !== s || (t.base = s),
                    t
            }
            if (null != e.snap) {
            ...
            if (e.autoScroll) {
                var d = Q(e.autoScroll) ? e.autoScroll : {
                    ...
                    c = {};
                c.target = Dt(d.target) ? d.target : window,
                    c.speed = [],
                ...
                c.sensitivity = c.speed.map(function(t, e) {
                        ...
                        var e = "min" + t,
                            n = "max" + t;
                        tt(d[e]) && d[e] >= 0 && (c[e] = d[e]),
                            tt(d[n]) && d[n] >= 0 && (!c[e] || d[n] >= c[e]) && (c[n] = d[n])
                    }),
            ...
            if (r && Kt(t), Dt(e.handle) && e.handle !== n.handle) {
                ...
                t.orgCursor = p.style.cursor,
                    Mt(p, t.orgCursor),
                    pt && (t.orgUserSelect = p.style[pt], p.style[pt] = "none"),
                    rt.addStartHandler(p, t.pointerEventHandlerId)
            ...
            var v = {
                ...
                h = void 0;
            tt(e.left) && e.left !== v.left && (v.left = e.left, h = !0),
                tt(e.top) && e.top !== v.top && (v.top = e.top, h = !0),
                h && Ut(t, v), ["onDrag", "onMove", "onDragStart", "onMoveStart", "onDragEnd"].forEach(function(r) {
        ...
        wt.move = function(t, e, n) {
                St.call(window, Ht),
                    Et(),
                    Ct === t && (e.x && Bt.x && (e.x.lastValue = Bt.x.lastValue), e.y && Bt.y && (e.y.lastValue = Bt.y.lastValue)),
                    Ct = t,
                    Bt = e,
                    Ot = n;
                var r = Date.now();
        ...
        var ee = function() {
            function t(e, n) {
                ...
                if (e instanceof SVGElement && (i = e.ownerSVGElement)) {
                    ...
                    r.svgTransform = e.transform.baseVal.appendItem(i.createSVGTransform()),
                        r.svgPoint = i.createSVGPoint();
                ...
                if (r.element = function(t, e) {
                        ...
                        return o && "none" !== o || (n[r] = "0 0 1px transparent"),
                            e && ft && (n[ft] = "translateZ(0)"),
                            t
        ...
        rt.addEndHandler(document, ne),
            rt.addCancelHandler(document, ne);
        var re = function() {
            ct = P.getName("transitionProperty"),
                ft = P.getName("transform"),
                dt = lt.style.cursor,
        ...
        (lt = document.body) ? re(): document.addEventListener("DOMContentLoaded",
            function() {
                lt = document.body,
                    re()
            }, !0);
